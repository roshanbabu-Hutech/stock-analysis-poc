...
export default function StockUniverseCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setBse_code(initialValues.bse_code);
    setNse_code(initialValues.nse_code);
    setIndustry(initialValues.industry);
    setCurrent_price(initialValues.current_price);
    setPrice_to_earning(initialValues.price_to_earning);
    setIndustry_pe(initialValues.industry_pe);
    setEps(initialValues.eps);
    setPromoter_holding(initialValues.promoter_holding);
    setDebt_to_equity(initialValues.debt_to_equity);
    setNet_profit_latest_quarter(initialValues.net_profit_latest_quarter);
    setYoy_quarterly_profit_growth(initialValues.yoy_quarterly_profit_growth);
    setSales_latest_quarter(initialValues.sales_latest_quarter);
    setYoy_quarterly_sales_growth(initialValues.yoy_quarterly_sales_growth);
    setRoce3yr_avg(initialValues.roce3yr_avg);
    setReturn_on_capital_employed(initialValues.return_on_capital_employed);
    setOpm(initialValues.opm);
    setProfit_after_tax(initialValues.profit_after_tax);
    setSales(initialValues.sales);
    setSales_growth_3years(initialValues.sales_growth_3years);
    setSales_growth_5years(initialValues.sales_growth_5years);
    setProfit_growth(initialValues.profit_growth);
    setProfit_growth_3years(initialValues.profit_growth_3years);
    setProfit_growth_5years(initialValues.profit_growth_5years);
    setProfit_growth_7years(initialValues.profit_growth_7years);
    setProfit_growth_10years(initialValues.profit_growth_10years);
    setAverage_return_on_equity_5years(
      initialValues.average_return_on_equity_5years
    );
    setAverage_return_on_equity_3years(
      initialValues.average_return_on_equity_3years
    );
    setReturn_on_equity(initialValues.return_on_equity);
    setReturn_over_1year(initialValues.return_over_1year);
    setReturn_over_3years(initialValues.return_over_3years);
    setReturn_over_5years(initialValues.return_over_5years);
    setReturn_on_assets(initialValues.return_on_assets);
    setSales_growth(initialValues.sales_growth);
    setSales_preceding_year(initialValues.sales_preceding_year);
    setSales_growth_7years(initialValues.sales_growth_7years);
    setOperating_profit_preceding_year(
      initialValues.operating_profit_preceding_year
    );
    setNet_profit_last_year(initialValues.net_profit_last_year);
    setSales_growth_10years(initialValues.sales_growth_10years);
    setAverage_earnings_5year(initialValues.average_earnings_5year);
    setFree_cash_flow_last_year(initialValues.free_cash_flow_last_year);
    setFree_cash_flow_preceding_year(
      initialValues.free_cash_flow_preceding_year
    );
    setNet_cash_flow_preceding_year(initialValues.net_cash_flow_preceding_year);
    setFree_acash_flow_3years(initialValues.free_acash_flow_3years);
    setAverage_return_on_capital_employed_3years(
      initialValues.average_return_on_capital_employed_3years
    );
    setAverage_return_on_capital_employed_5years(
      initialValues.average_return_on_capital_employed_5years
    );
    setDividend_yield(initialValues.dividend_yield);
    setOperating_cash_flow_3years(initialValues.operating_cash_flow_3years);
    setOperating_cash_flow_5years(initialValues.operating_cash_flow_5years);
    setOperating_cash_flow_7years(initialValues.operating_cash_flow_7years);
    setPrice_to_book_value(initialValues.price_to_book_value);
    setReturn_over_6months(initialValues.return_over_6months);
    setErrors({});
  };
  const validations = {
    name: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createStockUniverse.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "StockUniverseCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
